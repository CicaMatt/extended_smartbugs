...
contract FruitToken is StandardToken { 
    ...
    function FruitToken() {
        ...
        name = "FruitToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "FRUITS";                                             // Set the symbol for display purposes (CHANGE THIS)
