...
// ----------------------------------------------------------------------------------------------
// DFI  token by defiqa Limited.
// An ERC20 standard
//
// author: defiqa community
// Contact: support@defiqa.com
contract ERC20 {
...
contract defiqa is StandardToken, OnlyOwner{
	uint256 public constant decimals = 18;
    string public constant name = "defiqa";
    string public constant symbol = "DFI";
    string public constant version = "1.0";
    uint256 public constant totalSupply =210000*10**18;
