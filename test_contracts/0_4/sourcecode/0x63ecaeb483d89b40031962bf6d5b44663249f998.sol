...
contract DistributeDividends {
    ...
    /// @notice Distribute dividends to the GandhijiMain contract token holders.
    /// Can be called repeatedly until practically all dividends have been distributed.
    ...
    function distribute(uint256 rounds) public {
        for (uint256 i = 0; i < rounds; i++) {
            ...
            GandhijiMainContract.buy.value(address(this).balance)(0x0);
