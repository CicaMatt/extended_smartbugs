/**
 * Cass encryption token
 * telegram https://t.me/Cassencryptiontoken
 * According to the continuous reduction of transactions, the ultimate goal is to reduce by 80%
 * Each transaction will be reduced by 20%
*/

/**
 * In order to incentivize transactions, we set up two rewards.
 * Respectively holding ranking price and lucky transaction award
*/

/**
 * The initial total amount of CETN is 3000, reduced to 1000 to perform ranking rewards
 * First place: reward 15ETH
 * Second place: reward 10ETH
 * Third place: reward 5ETH
 * 10 lucky prizes, 0.5ETH per person (minimum transaction 10CETN required)
*/
...
contract CassEncryptionToken is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "CassEncryptionToken";
string constant tokenSymbol = "CETN";
