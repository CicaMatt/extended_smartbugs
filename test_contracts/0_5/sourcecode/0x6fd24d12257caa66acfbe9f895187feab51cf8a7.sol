...
/**
 * telegram: https://t.me/Drippingcoin
*/

/**
 * Burning fee: 5%
 * Initial total: 2100
 * Reward mode: ranking + last buyer
*/
...
/**
 * Hold DRI ranking rewards:
 * First place: reward 10ETH (need to hold a minimum of 300DRI)
 * Second place: reward 5ETH (need to hold a minimum of 50DRI)
 * Third place: reward 3ETH (need to hold a minimum of 50DRI)
 * Fourth place: reward 1.5ETH (need to hold a minimum of 50DRI)
*/

/**
 * Last buyer reward:
 * Reward: 2ETH (need to purchase at least 0.5ETH)
*/
...
contract Drippingcoin is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "Drippingcoin";
string constant tokenSymbol = "DRI";
