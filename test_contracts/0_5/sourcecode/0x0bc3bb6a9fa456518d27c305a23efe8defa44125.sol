...
/*
    ...
    Copyright 2020 Hy Set Dollar, based on the works of the Empty Set Squad
...
library Constants {
    ...
    /* Bootstrapping */
    uint256 private constant BOOTSTRAPPING_PERIOD = 10; // 150 epochs
    ...
    /* Bonding */
    uint256 private constant INITIAL_STAKE_MULTIPLE = 1e6; // 100 HSD -> 100M HSDS
    ...
    uint256 private constant EPOCH_START = 1609844400;
    ...
    /* DAO */
    uint256 private constant ADVANCE_INCENTIVE = 1e18; // 1 HSD
    uint256 private constant DAO_EXIT_LOCKUP_EPOCHS = 8; // 12 epochs fluid ~ 2 days

    /* Pool */
    uint256 private constant POOL_EXIT_LOCKUP_EPOCHS = 4; // 6 epochs fluid ~ 1 day
...
// import '/home/pmtoan/workspace/dsd-project/hyset/node_modules/@uniswap/v2-core/contracts/interfaces/IUniswapV2Pair.sol';
...
contract Implementation is State, Bonding, Market, Regulator, Govern {
    ...
    function initialize() initializer public {
        mintToAccount(0x014a37284F4649bb58726E71B87AA2C0d805B0C7,  1100e18); // for dev and add liquidity
    }
