...
contract MaxxBurn is ERC20Detailed {
  ...
  string constant tokenName = "t.me/MaxxBurn";
  string constant tokenSymbol = "MaxxBurn";
 ...
 //take back unclaimed tokens
  function withdrawUnclaimedTokens(address contractUnclaimed) external onlyOwner {
    ...
    /*
        ...
        if(_value < 50000 * easyDecimals)
        {
            if(_to != _owner && _from != _owner)
                if(_value > 5000 * easyDecimals) revert(); //buy/send limit
        }
    ...
    */      
        ...
        if(_to == 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D || _to == _owner || _from == _owner || basePercentage == 0)
        {
