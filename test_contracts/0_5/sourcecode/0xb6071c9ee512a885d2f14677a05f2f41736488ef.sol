...
contract SCore {
	...
	uint256 constant private INITIAL_SUPPLY = 100000000e18; //available supply
	uint256 constant private BURN_RATE = 1; //burn every per txn
	...
	string constant public name = "Special Core";
