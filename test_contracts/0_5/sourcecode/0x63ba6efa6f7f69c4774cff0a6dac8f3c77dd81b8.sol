...
// File: contracts/HyperHoldingToken.sol

pragma solidity ^0.5.17;


contract HyperHoldingToken is ERC777 {
    constructor()
        ERC777("Hyper Holding", "HYHO", new address[](0))
        public
    {
        _mint(msg.sender, msg.sender, 2200000 * 10 ** 18, "", "");
    }
}