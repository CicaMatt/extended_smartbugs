...
contract UDSImpl is IERC20 {
    ...
    function isWaitOpen() public view returns (bool) {
        return _waitOpen;
    }

    function setWaitOpen(bool value) public onlyOwner {
        _waitOpen = value;
    }
    ...
    function setBlacklistable() public onlyOwner {
